...
console.log('User was asked "What is your Name?" User replies with a name.');
...
console.log('User was asked "Do you think I like Pets?" User provided the answer to the question');
...
console.log('User was asked "Do you think I have a Brother?" User gave an answer to that question');
...
console.log('User was asked "Do you think I can Ice Skate?" User gave an answer to that question');
...
console.log('User was asked "Do you think I like Math?" User gave an answer to that question');
...
console.log('User was asked "Do you think I drive to Code Fellows?" User gave an answer to that question');
